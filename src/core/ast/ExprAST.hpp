...
struct AsyncExprAST : ExprAST {
    ...
    AsyncExprAST() : ExprAST(ASTKind::AsyncExpr) {}
};
...
struct AwaitExprAST : ExprAST {
    ...
    AwaitExprAST() : ExprAST(ASTKind::AwaitExpr) {}
};
...
struct SpawnExprAST : ExprAST {
    ...
    SpawnExprAST() : ExprAST(ASTKind::SpawnExpr) {}
};
...
struct JoinExprAST : ExprAST {
    ...
    JoinExprAST() : ExprAST(ASTKind::JoinExpr) {}
};
...
using AsyncExprPtr = AsyncExprAST*;
using AwaitExprPtr = AwaitExprAST*;
using SpawnExprPtr = SpawnExprAST*;
using JoinExprPtr = JoinExprAST*;
