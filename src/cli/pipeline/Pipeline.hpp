/// @file cli/pipeline/Pipeline.hpp
...
struct PipelineResult {
    ...
    /// @brief LLVM IR text (valid after EmitIR stage)
    std::string llvmIR;
...
///   EmitIR  → Generate and serialize LLVM IR (stopAt = EmitIR)
...
///   lucid emit-ir  → stopAt = EmitIR,   output = LLVM IR text
